/****** Object:  Database [EvolentContacts]    Script Date: 8/3/2018 2:27:01 PM ******/
CREATE DATABASE [EvolentContacts]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'EvolentContacts', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\EvolentContacts.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'EvolentContacts_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\EvolentContacts_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [EvolentContacts] SET COMPATIBILITY_LEVEL = 130
GO
...
ALTER DATABASE [EvolentContacts] SET RECOVERY FULL 
GO
...
ALTER DATABASE [EvolentContacts] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [EvolentContacts] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [EvolentContacts] SET QUERY_STORE = OFF
GO
